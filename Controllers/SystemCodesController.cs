...
namespace EmployeeManagement.Controllers
{
    public class SystemCodesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Code,Description,CreatedById,CreatedOn,ModifiedById,ModifieddOn")] SystemCode systemCode)
        {
            if (ModelState.IsValid)
            {
                systemCode.CreatedById="Khaled";
                systemCode.CreatedOn=DateTime.Now;
                systemCode.ModifiedById="Khaled";
                systemCode.ModifieddOn=DateTime.Now;
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Code,Description,CreatedById,CreatedOn,ModifiedById,ModifieddOn")] SystemCode systemCode)
        {
            if (id != systemCode.Id)
            {
                return NotFound();
